      ...
      <div className="hero min-h-screen bg-cover bg-center relative"
        ...
        <div className="hero-content text-center text-white px-4">
          <div className="max-w-3xl animate-fadeInUp">
            ...
            <a href="#Features" className="inline-flex items-center justify-center gap-3 px-8 py-4 text-xl font-bold rounded-full bg-white text-blue-600 hover:bg-gradient-to-r hover:from-blue-400 hover:via-blue-500 hover:to-blue-600 hover:text-white shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-300" > 🚀 เริ่มต้นเลย </a>
          </div>
        </div>
      </div>
      ...
      <section className="py-16 bg-base-100 ">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 ">
            {[...Array(5).keys()].map((i) => (
              <div key={i} className="card  rounded-2xl  bg-white shadow-xl hover:scale-110 hover:shadow-xl transition-transform">
                <figure>
                  <img
                  ...
                  />
                  <div className="absolute top-2 left-2 bg-red-500 text-white text-xs px-2 py-1 rounded-lg shadow"> NEW </div>
                </figure>
